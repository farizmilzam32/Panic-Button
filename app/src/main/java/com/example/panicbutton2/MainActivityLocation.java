...
public class MainActivityLocation extends AppCompatActivity {
    ...
    public String phonelinetext = getTelp();
    ...
    // share location with number telephone you input before
    public void shareLocation(View view) {
        ...
        smsIntent.putExtra("address"  , getTelp());
        ...
        try {
            ...
            Toast.makeText(MainActivityLocation.this,
    ...
    //get number telephone from firebase
    public String getTelp(){
        ...
        ValueEventListener eventListener = new ValueEventListener() {
            ...
            public void onDataChange(DataSnapshot dataSnapshot) {
                String phonelineTxt2 = dataSnapshot.child("phone").getValue(String.class);

                phonelinetext = phonelineTxt2;

...
public class MainActivityLocationSMSFireFighter extends AppCompatActivity {
    ...
    public void shareLocation(View view) {
        ...
        smsIntent.putExtra("address"  , ("000000000"));
        smsIntent.putExtra("sms_body"  , "Tolong ada kebakaran" +"\n"+"https://www.google.com/maps/place/"+lastLocation.getLatitude()+","+lastLocation.getLongitude());
        ...
        try {
            ...
            Toast.makeText(MainActivityLocationSMSFireFighter.this,
